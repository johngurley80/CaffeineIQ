    ...
    <>
      ...
      <main className="mx-auto max-w-wrap px-wrap-sm py-section-sm md:px-wrap md:py-section">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          <HowItWorksStep number="01" icon={<Icon name="cup" />} title="Daily limit" body="Bodyweight sets the base limit, while pregnancy, breastfeeding, and health flags apply stricter caps." />
